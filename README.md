...
![CASE Statement Output](output_1_case_statement.png)
...
![JOIN GROUP BY Output](output_2_join_groupby.png)
...
![Pivot Output](output_3_pivot_india_australia.png)
...
![Subquery Output](output_4_subquery_not_in.png)
...
![Date Function Output](output_5_monthly_1k_boxes.png)
...
| File | Description |
|---|---|
| `awesome_chocolates_sql_queries.sql` | All queries with section-by-section comments |
| `awesome-chocolates-dataset.sql` | Database schema and sample data to run locally |
...
2. Run `awesome-chocolates-dataset.sql` to create and populate the database
3. Open `awesome_chocolates_sql_queries.sql`
